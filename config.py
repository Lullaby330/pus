...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6708021698:AAGqub4TskKWQ14BOgPO7p-y4kY47wZdE_o")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS",  "5895781400 6658692461").split()):
        ADMINS.append(int(x))
except ValueError:
